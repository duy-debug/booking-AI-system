...
def _build_llm_messages(
    *,
    ...
    system_prompt = (
        ...
        "service_name, main_course_name, addon_name, skip_addon. "
        "main_course_name=liệu trình chính; addon_name=tùy chọn; "
        "service_name=chưa rõ loại. Cùng câu có main+addon thì tách đủ. Chỉ đặt "
...
# Entity resolution implementation lives in application handlers; these imports keep
# the old dialog.nlu import path compatible during the transition.
from app.application.handlers.entity_resolution_handler import (  # noqa: F401
    EntityCandidate,
